...
DocumentReference? get currentUserReference =>
    loggedIn ? CocareaiRecord.collection.doc(currentUser!.uid) : null;

CocareaiRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : CocareaiRecord.getDocument(CocareaiRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
